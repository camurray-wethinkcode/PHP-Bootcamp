...
<head>
    ...
    <title>Pleasers - My Account</title>
...
<div class="top-div">
    ...
    <div class="main">
        <div class="window bigger">
            <div class="title"><p class="title-txt">My Preferences</p></div>
            <form action="modif.php" method="POST">
                <?php if ($_GET['request'] == "error") {?>
                <input class="form invalid" type="email" name="login" placeholder="Email invalid"><br>
                <input class="form invalid" type="password" name="oldpw" placeholder="Password invalid"><br>
                <input class="form invalid" type="password" name="newpw" placeholder="Password invalid"><br>
                <?php } else {?>
                <input class="form" type="email" name="login" placeholder="Enter email"><br>
                <input class="form" type="password" name="oldpw" placeholder="Enter current password"><br>
                <input class="form" type="password" name="newpw" placeholder="Enter new password"><br>
                <?php }?>
                <button class="form-button" type="submit" name="submit" value="OK">Update</button>
            </form>
            <a href="delete.php"><button class="form-button">Delete My Account</button></a>
        </div>
    </div>
</body>
</html>
