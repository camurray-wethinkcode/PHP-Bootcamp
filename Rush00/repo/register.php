...
<div class="top-div">
    ...
    <div class="main">
        <div class="window">
            <div class="title"><p class="title-txt">Register</p></div>
                <form action="create.php" method="POST">
                    ...
                    <input class="form invalid" type="password" name="confirm" placeholder="Password invalid"><br>
                    <?php } else {?>
                    ...
                    <input class="form" type="password" name="confirm" placeholder="Confirm password"><br>
                    <?php }?>
                    <button class="form-button" type="submit" name="submit" value="OK">Register</button>
                </form>
        </div>
    </div>
</body>
